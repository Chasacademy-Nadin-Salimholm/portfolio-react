...
function Cookwise() {
  return (
    <CookwiseContainer>
      ...
      <StyledParagraph>
        We were tasked with creating a smart app for smart ovens and a complete design system, from the idea phase to full-scale design. We worked in a group and stayed within the framework to understand how the app would contribute to a simplified everyday life.
        The assignment was to create a smart app that allows users to set the desired temperature, function settings, set a desired time, recipe program, and receive notifications. I was involved in this project from the idea phase to full-scale design. We conducted interviews, analyzed surveys, and performed user testing. Together, we created wireframes and a complete prototype.
      ...
      <div>
        <h2>Define & analyze</h2>
      </div>
      <StyledDefineImage src={Define} alt="Define Image" />
      <StyledParagraph>
        We used an affinity diagram to analyze our brainstorming and divide our thoughts into three categories. This enabled us to focus on the most important challenges, ideas, and uncertainties in order to create a simple and easy-to-navigate app.
      </StyledParagraph>

      <div>
        <h2>Wireframe & Skiss</h2>
      </div>
      <StyledParagraph>
        We sketched on paper together how each frame would look to have a foundation to work from. We brainstormed how wireframes would look like and where to place functions, buttons, recipes, navbar, etc. on the iPhone 14 Pro.
      </StyledParagraph>
      <StyledSketchImage src={Sketch} alt="Sketch Image" />

      <div>
        <h2>High-fidelity & Low-fidelity wireframes</h2>
      </div>
